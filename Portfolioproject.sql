...
-- Repairing and experiencing with this--
SELECT location, population, MAX(total_cases) AS Highest_Infection_Count, MAX(total_deaths) AS Total_deaths, 
	MAX((total_cases/population))*100 as Percent_Population_Infected,
	MAX((total_deaths/population))*100 as Percent_Population_Death, MAX((total_deaths/total_cases))*100 as Percent_Infected_Death
FROM covid_deaths
WHERE continent is not null
and continent != ''
GROUP BY location, population 
